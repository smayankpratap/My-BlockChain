...
describe('Transaction', () => {
    ...
    describe('validTransaction()', () => {
        ...
        describe('when the transaction is invalid', () => {
            describe('and a transation outputMap value is invalid', () => {
                it('returns false and logs the error', () => {
                    transaction.outputMap[senderWallet.publicKey] = 69696969;
    ...
    describe('rewardTransaction()', () => {
        ...
        beforeEach(() => {
            ...
            rewardTransaction = Transaction.rewardTransaction({ minerWallet }); // minerWallet --> recipient's wallet
        });
